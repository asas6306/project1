				...
				<div class="p-2 text-xl w-full">
					<div class="flex justify-between text-4xl">
						...
						<div class="flex items-center">
							<a href="userUpdate?uid=${member.uid}" class="bg-blue-300 hover:bg-blue-500 rounded-full p-1 text-sm">
								<i class="fas fa-user-edit"></i>
								<span>회원수정</span>
							</a>
							<a href="delete?uid=${member.uid}" class="bg-red-300 hover:bg-red-500 rounded-full p-1 ml-2 text-sm" onclick="return confirm('정말로 삭제하시겠습니까?');">
