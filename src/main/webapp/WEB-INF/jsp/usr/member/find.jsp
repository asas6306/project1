...
<script>
const FindForm__checkAndSubmitDone = false;
function FindForm__checkAndSubmit(form) {
...
form.submit();
FindForm__checkAndSubmitDone = true;
}
</script>
			...
			<form action="doFind" method="post" onsubmit="FindForm__checkAndSubmit(this); return false;">
				<div class="text-gray-900 text-xl">
					...
					<div class="flex justify-center">
						...
						<div class="p-1"></div>
						<input type="button" value="취소" class="rounded p-1 px-2 bg-red-300 hover:bg-red-500"/>
					</div>
